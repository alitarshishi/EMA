...
public class reminder extends AppCompatActivity {
    ...
    private void setAlarm(String text, String date, String time) {
        ...
        Intent intentBack = new Intent(getApplicationContext(), MainDisplay.class);                //this intent will be called once the setting alarm is complete
        intentBack.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivity(intentBack);                                                                  //navigates from adding reminder activity to mainaDisplay
    }
